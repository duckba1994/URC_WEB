            ...
            <div class="nicescroll-bar" id="myDIV">
                <div class="navbar-nav-wrap">
                    <ul class="navbar-nav flex-column">
                        ...
                        <li class="nav-item">
                            <a class="nav-link {{ (request()->is('customer-api')) ? 'btn2' : '' }} {{ (request()->is('data_name_store')) ? 'btn2' : '' }} {{ (request()->is('lead')) ? 'btn2' : '' }}"
                        ...
                        <li class="nav-item">
                            <a class="nav-link {{ (request()->is('data_search_product')) ? 'btn2' : '' }}
                                ...
                                {{ (request()->is('data_report_historical-month')) ? 'btn2' : '' }}"
